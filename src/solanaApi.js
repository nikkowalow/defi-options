...
exports.loadProgram = exports.airdropTest = exports.isValidKey = exports.getBalance = exports.airdrop = exports.getCluster = exports.newAccountWithLamports = exports.connect = exports.CLUSTER = void 0;
...
var demoAccount;
var voterAccount;
var programId = new web3_js_1.PublicKey("Gqj6LTnJy1c1tV4oXGek2nrozKsX2TCQoSUKpXR8doKe");
...
function connect() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            connection = new web3_js_1.Connection(exports.CLUSTER, 'singleGossip');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, connection.requestAirdrop(demoAccount.publicKey, amount)];
                case 1:
                    drop = _a.sent();
...
function getBalance(key) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connection.getBalance(key)];
                case 1:
                    balance = _a.sent();
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    _b = (_a = console).log;
                    return [4 /*yield*/, connection.getBalance(acc.publicKey)];
                case 1:
                    _b.apply(_a, [_e.sent()]);
...
function loadProgram() {
    return __awaiter(this, void 0, void 0, function () {
        var votedOnAccount, space, lamports, transaction;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!votedOnPubkey) return [3 /*break*/, 3];
                    votedOnAccount = new web3_js_1.Account();
                    votedOnPubkey = votedOnAccount.publicKey;
                    console.log('Creating account', votedOnPubkey.toBase58(), 'to say hello to');
                    console.log(programId.toString());
                    space = votedOnAccountLayout.span;
                    return [4 /*yield*/, connection.getMinimumBalanceForRentExemption(votedOnAccountLayout.span)];
                case 1:
                    lamports = _a.sent();
                    transaction = new web3_js_1.Transaction().add(web3_js_1.SystemProgram.createAccount({
                        fromPubkey: voterAccount.publicKey,
                        newAccountPubkey: votedOnPubkey,
                        lamports: lamports,
                        space: space,
                        programId: programId
                    }));
                    return [4 /*yield*/, web3_js_1.sendAndConfirmTransaction(connection, transaction, [voterAccount, votedOnAccount], {
